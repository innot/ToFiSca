...
import mock_picamera2.formats as formats
import mock_picamera2.platform as Platform
import mock_picamera2.utils as utils
from mock_picamera2.allocators import Allocator, DmaAllocator
from mock_picamera2.encoders import Encoder, H264Encoder, MJPEGEncoder, Quality
from mock_picamera2.outputs import FfmpegOutput, FileOutput
from mock_picamera2.previews import DrmPreview, NullPreview, QtGlPreview, QtPreview
...
class Picamera2:
    ...
    def create_preview_configuration(self, main={}, lores=None, raw={}, transform=libcamera.Transform(),
        ...
        if "NoiseReductionMode" in self.camera_controls and "FrameDurationLimits" in self.camera_controls:
            controls = {"NoiseReductionMode": libcamera._controls.draft.NoiseReductionModeEnum.Minimal,
    ...
    def create_still_configuration(self, main={}, lores=None, raw={}, transform=libcamera.Transform(),
        ...
        if "NoiseReductionMode" in self.camera_controls and "FrameDurationLimits" in self.camera_controls:
            controls = {"NoiseReductionMode": libcamera._controls.draft.NoiseReductionModeEnum.HighQuality,
    ...
    def create_video_configuration(self, main={}, lores=None, raw={}, transform=libcamera.Transform(),
        ...
        if "NoiseReductionMode" in self.camera_controls and "FrameDurationLimits" in self.camera_controls:
            controls = {"NoiseReductionMode": libcamera._controls.draft.NoiseReductionModeEnum.Fast,
    ...
    def configure_(self, camera_config="preview") -> None:
        ...
        self.camera_ctrl_info = {}
        self.camera_properties_ = {}
        for k, v in self.camera._controls.items():
            self.camera_ctrl_info[k.name] = (k, v)
        for k, v in self.camera.properties.items():
            self.camera_properties_[k.name] = utils.convert_from_libcamera_type(v)
